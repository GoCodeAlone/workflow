...
## Consequences
**Positive**: Non-developers can create applications; configs are validatable via JSON Schema; enables visual builder UI with YAML import/export; runtime reconfiguration without recompilation; 100+ example configs as documentation; easy to version control and diff.
