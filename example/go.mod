...
require (
	...
	github.com/CrisisTextLine/modular/modules/database/v2 v2.3.0 // indirect
	github.com/CrisisTextLine/modular/modules/eventbus v1.5.0 // indirect
	github.com/CrisisTextLine/modular/modules/eventlogger v0.6.0 // indirect
	github.com/CrisisTextLine/modular/modules/httpclient v0.4.0 // indirect
