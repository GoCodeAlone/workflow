...
const PLUGIN_NAV_ITEMS: NavItem[] = [
  { view: 'store-browser' as ActiveView, label: 'Store Browser', icon: 'M4 5h16v2H4V5zm0 4h16v10H4V9zm2 2v6h12v-6H6z' },
  { view: 'docs' as ActiveView, label: 'Documentation', icon: 'M18 2H6c-1.1 0-2 .9-2 2v16c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2zm0 18H6V4h2v8l2.5-1.5L13 12V4h5v16z' },
];
...
const WORKFLOW_VIEWS = new Set<ActiveView>(['executions', 'logs', 'events']);
