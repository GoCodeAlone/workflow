      ...
      >
        ...
        <div style={{ textAlign: 'center', marginBottom: 24 }}>
          ...
          <p style={{ color: '#a6adc8', margin: '8px 0 0', fontSize: 14 }}>
            Build and manage workflow pipelines
          </p>
        </div>
        ...
        >
          <button
            ...
            style={{
              ...
              fontWeight: 600,
              cursor: 'pointer',
              background: mode === 'signin' ? '#89b4fa' : 'transparent',
              color: mode === 'signin' ? '#1e1e2e' : '#a6adc8',
            }}
          >
            Sign In
          </button>
          <button
            ...
            style={{
              ...
              fontWeight: 600,
              cursor: 'pointer',
              background: mode === 'signup' ? '#89b4fa' : 'transparent',
              color: mode === 'signup' ? '#1e1e2e' : '#a6adc8',
            }}
          >
            Sign Up
          </button>
