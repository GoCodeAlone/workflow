...
require (
	...
	github.com/GoCodeAlone/modular/modules/cache v0.1.2
	...
	github.com/GoCodeAlone/modular/modules/httpserver v0.1.0
	github.com/GoCodeAlone/modular/modules/jsonschema v1.0.13
	github.com/GoCodeAlone/modular/modules/reverseproxy v1.1.0
	github.com/GoCodeAlone/modular/modules/scheduler v0.1.0
