...
require (
	...
	github.com/GoCodeAlone/modular/modules/auth v0.0.6
	github.com/GoCodeAlone/modular/modules/cache v0.0.4
	github.com/GoCodeAlone/modular/modules/chimux v1.0.7
	github.com/GoCodeAlone/modular/modules/eventbus v0.0.7
	github.com/GoCodeAlone/modular/modules/httpserver v0.0.4
	github.com/GoCodeAlone/modular/modules/reverseproxy v1.0.11
	github.com/GoCodeAlone/modular/modules/scheduler v0.0.6
